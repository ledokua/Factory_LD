...
public final class ClientPlayNetworking {
	 ...
	 * @see ClientPlayNetworking#unregisterGlobalReceiver(class_2960)
	 * @see ClientPlayNetworking#registerReceiver(class_8710.class_9154, PlayPayloadHandler)
	 */
	 ...
	 * @see ClientPlayNetworking#registerGlobalReceiver(class_8710.class_9154, PlayPayloadHandler)
	 * @see ClientPlayNetworking#unregisterReceiver(class_2960)
	 */
	public static ClientPlayNetworking.@Nullable PlayPayloadHandler<?> unregisterGlobalReceiver(class_2960 id) {
	 ...
	 *
	 * <p>If a handler is already registered for the {@code type}, this method will return {@code false}, and no change will be made.
	 * Use {@link #unregisterReceiver(class_2960)} to unregister the existing handler.
	 *
	 * <p>For example, if you only register a receiver using this method when a {@linkplain ClientLoginNetworking#registerGlobalReceiver(class_2960, ClientLoginNetworking.LoginQueryRequestHandler)}
	 ...
	 * @param id the payload id
	 * @return the previous handler, or {@code null} if no handler was bound to the channel,
	 * or it was not registered using {@link #registerReceiver(class_8710.class_9154, PlayPayloadHandler)}
	 * @throws IllegalStateException if the client is not connected to a server
	 */
	public static ClientPlayNetworking.@Nullable PlayPayloadHandler<?> unregisterReceiver(class_2960 id) {
		final ClientPlayNetworkAddon addon = ClientNetworkingImpl.getClientPlayAddon();
	...
	public static void send(class_8710 payload) {
		...
		// You cant send without a client player, so this is fine
		if (class_310.method_1551().method_1562() != null) {
			class_310.method_1551().method_1562().method_52787(createC2SPacket(payload));
			return;
		}
	...
	/**
	 * A thread-safe payload handler utilizing {@link class_8710}.
	...
	public interface PlayPayloadHandler<T extends class_8710> {
		 ...
		 * }</pre>
		 *
		 * <p>The network handler can be accessed via {@link class_746#field_3944}.
		 *
